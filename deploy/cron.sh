...
# */10 14-23 * * * /home/ec2-user/project11-web-api/deploy/cron.sh >> cron-project11-web-api.log 2>&1
# */10 0 * * * /home/ec2-user/project11-web-api/deploy/cron.sh >> cron-project11-web-api.log 2>&1
# */10 1-4 * * * /home/ec2-user/project11-web-api/deploy/cron.sh >> cron-project11-web-api.log 2>&1
################################################################################
